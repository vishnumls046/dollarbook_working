...
open class MSBBarChartView: UIView {
    ...
    var yAxisNumberOfInterval: Int = 3
    ...
    private var yAxisLabelWidth: CGFloat = 30.0

    private let yAxisMaxInterval: Int = 50
...
extension MSBBarChartView {
    ...
    private func createYAxisLabels(maxEntry: BarEntry) -> [String] {
        ...
        while true {
            ...
            yAxisLabels.append(String(format: "%i", insertValue))
        }
    }
