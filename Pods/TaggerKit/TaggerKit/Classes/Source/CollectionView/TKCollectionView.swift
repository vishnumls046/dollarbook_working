...
public class TKCollectionView: UIViewController {
    ...
    public var customFont = UIFont.boldSystemFont(ofSize: 12)
    ...
    public var customCornerRadius = CGFloat(12.0)
    
    /// The background color of the tag view
    //public var customBackgroundColor = UIColor(red: 1.00, green: 0.80, blue: 0.37, alpha: 1.0)
    public var customBackgroundColor = UIColor(red: 243/255, green: 241/255, blue: 249/255, alpha: 1.0)
    /// The color of the tag cell border, if present
    public var customTagBorderColor: UIColor?
    //public var customTagBorderColor = UIColor(red: 145/255, green: 111/255, blue: 239/255, alpha: 1.0)
    //public var customTagBorderColor = UIColor.white
    /// The border of the tag cell view
    //public var customTagBorderWidth: CGFloat?
    public var customTagBorderWidth = 2.0
